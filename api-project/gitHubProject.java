...
public class gitHubProject {
        ...
        public void setup(){
            req =  new RequestSpecBuilder().setContentType(ContentType.JSON).
                    addHeader("Authorization","token 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").
                    setBaseUri(baseURI).build();
        }
        @Test(priority=0)
        public void postTest(){

            String filePath = System.getProperty("user.dir") + "\\src\\test\\java\\liveprojects\\request.json";
